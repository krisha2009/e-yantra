<?php
  ...
  if(isset($_POST['submit'])) {
    if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['contact_no']) && isset($_POST['password']) ) {
      ...
      $verifyQuery = 'SELECT * FROM peopleinfo WHERE name='."'"."$name"."'".'';
      $addQuery = "INSERT INTO peopleinfo(name, email, contact_no, password) VALUES('$name', '$email', '$contact_no', '$password')";
...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" action="homepage.html" method="POST">
				...
				<div class="wrap-input1 validate-input" data-validate="Contact number is required">
					<input class="input1" type="number" min="10" max="10" name="contact_no" placeholder="Contact Number">
					<span class="shadow-input1"></span>
				</div>


				<div class="wrap-input1 validate-input" data-validate="Password is required">
					<input class="input1" type="password" name="password" placeholder="Password" id="pass1">
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" >
					<input class="input1" type="password" name="cpassword" placeholder="Confirm Password" id="pass2"onkeyup="checkPass(); return false;" >
					<span class="shadow-input1"></span>
				</div>
...
<script src="/code_examples/passtest.js" type="text/javascript">
	function checkPass()
{
